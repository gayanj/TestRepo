...
namespace Msftlayer
{
    public class ClCandidates
    {
        ...
        {
            var mlc = new MlCandidates();
            return mlc.Getcanidbyappid(appid);
        }
        ...
        {
            var mlcan = new MlCandidates();
            mlcan.Updatecandidatetable(cfirstname, clastname, address1, address2, address3, town, county, country,
        ...
        {
            var mlcan = new MlCandidates();
            return mlcan.Getcandidatesindb(uusername);
        }
    }
}