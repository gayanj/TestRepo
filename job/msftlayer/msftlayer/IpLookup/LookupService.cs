...
namespace Msftlayer.IpLookup
{
    public class LookupService
    {
        ...
        private static readonly String[] countryCode = {
                                                           ...
                                                           "ES", "ET", "FI",
                                                           "FJ", "FK", "FM", "FO", "FR", "FX", "GA", "GB", "GD", "GE", "GF",
                                                           "GH", "GI", "GL",
                                                           "GM", "GN", "GP", "GQ", "GR", "GS", "GT", "GU", "GW", "GY", "HK",
                                                           "HM", "HN", "HR",
                                                           "HT", "HU", "ID", "IE", "IL", "IN", "IO", "IQ", "IR", "IS", "IT",
                                                           "JM", "JO", "JP",
                                                           ...
                                                           "PT", "PW", "PY",
                                                           "QA", "RE", "RO", "RU", "RW", "SA", "SB", "SC", "SD", "SE", "SG",
                                                           "SH", "SI", "SJ",
        ...
        private static readonly String[] countryName = {
                                                           ...
                                                           "" +
                                                           "Palestinian Territory, Occupied", "Portugal", "Palau",
                                                           "Paraguay", "Qatar",
        ...
        public LookupService(String databaseFile, int options)
        {
            try
            {
                file = new FileStream(databaseFile, FileMode.Open, FileAccess.Read);
                dboptions = options;
                init();
            }
