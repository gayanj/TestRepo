...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="ln_fixx4"></div>
            ...
            <a href="/ResetPassword.aspx" class="ft_bluelink">I forgot my password</a>
            <div class="dv_fix">
            </div>
            <div class="ln_fixx6">
            </div>
            ...
            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="button" OnClick="LinkButton2_Click"
