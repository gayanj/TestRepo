<%@ Page Title="" Language="C#" MasterPageFile="~/Cms/Cms.Master" AutoEventWireup="true"
    CodeBehind="CmsHelpQuestions.aspx.cs" Inherits="JB.Cms.CmsHelpQuestions" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="Labelheaddetail" runat="server" Text="Help Questions" CssClass="ft_cmsheading1"></asp:Label>
    <div class="ln_dotccc">
    </div>
        ...
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    ...
                    <div class="w80">
                        <asp:Label ID="Label1" runat="server" CssClass="ft_black" Text='<%# Bind("Question") %>'></asp:Label>
                    </div>
                    <div class="w5">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("idtb_helpcenterqs", "CmsDelHelpQuestion.aspx?QuestionId={0}") %>'
                            Text="Delete" CssClass="ft_bluelink">
                        </asp:HyperLink></div>
                    <div class="w5">
                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("idtb_helpcenterqs", "CmsEditHelpQuestion.aspx?QuestionId={0}") %>'
