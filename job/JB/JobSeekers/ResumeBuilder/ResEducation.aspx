<%@ Page Title="" Language="C#" MasterPageFile="~/Jobseekers/Candidates.Master" AutoEventWireup="true"
    CodeBehind="ResEducation.aspx.cs" Inherits="JB.Jobseekers.ResumeBuilder.ResEducation" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="cn_header">
        <asp:Label ID="Label27" runat="server" Text="Educational Highlights" CssClass="ft_white"></asp:Label>
    </div>
    <br />
    <div class="time_left">
        <div class="ft_black">
            Please use Add button after filling in details to see live previews of qualifications on right
        </div>
    </div>
    <div class="time_right">
        <div class="resume_left">
            <asp:Label ID="Label1" runat="server" Text="School Name" CssClass="ft_black"></asp:Label>
            ...
            <br />
            <asp:Label ID="Label29" runat="server" Text="Degree Earned" CssClass="ft_black"></asp:Label>
        ...
        <div class="resume_right">
            ...
            <br />
            <div class="w30">
                <asp:Label ID="Label3" runat="server" Text="School Name" CssClass="ft_blackbd"></asp:Label>
            </div>
            <div class="w40">
                <asp:Label ID="Label4" runat="server" Text="Degree" CssClass="ft_blackbd"></asp:Label>
            </div>
            <div class="w10">
            ...
            <asp:GridView ID="GridEducation" runat="server" AutoGenerateColumns="False" DataKeyNames="id_res_education"
                ShowHeader="False" OnRowCommand="GridEducation_RowCommand" OnRowDeleting="GridEducation_RowDeleting">
                <Columns>
                    <asp:TemplateField HeaderText="School">
                        <ItemTemplate>
                            <div class="w30">
                                <asp:Label ID="Label1" runat="server" CssClass="ft_black" Text='<%# Bind("rschoolname") %>'></asp:Label>
                            </div>
                            <div class="w40">
                                <asp:Label ID="Label2" runat="server" CssClass="ft_black" Text='<%# Bind("rqualification") %>'></asp:Label>
                            </div>
                            <div class="w10">
                                <asp:LinkButton ID="LinkButton1" CssClass="ft_bluelink" runat="server" CommandName="Edit"
                                    CommandArgument='<%#Eval("id_res_education") %>' CausesValidation="false">Edit</asp:LinkButton>
                            </div>
                            <div class="w10">
                                <asp:LinkButton ID="LinkButton2" CssClass="ft_bluelink" runat="server" CommandName="Delete"
                                    CommandArgument='<%#Eval("id_res_education") %>' CausesValidation="false">Remove</asp:LinkButton>
                            </div>
                            <div class="dv_fix">
                            </div>
                            <div class="ln_dotted">
        ...
        <div class="resume_center">
            ...
            <br />
            <br />
            <asp:Button ID="ButtonSave" runat="server" Text="Continue to Experience" CausesValidation="false" CssClass="button" OnClick="ButtonSave_Click" />
        </div>
    </div>
    <div class="dv_fix">
    </div>
